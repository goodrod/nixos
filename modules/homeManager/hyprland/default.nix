    ...
    wayland.windowManager.hyprland = {
      ...
      settings = {
        ...
        bind = [
          ...
          "$mainMod CTRL, 1, focusworkspaceoncurrentmonitor, 1"
          "$mainMod CTRL, 2, focusworkspaceoncurrentmonitor, 2"
          "$mainMod CTRL, 3, focusworkspaceoncurrentmonitor, 3"
          "$mainMod CTRL, 4, focusworkspaceoncurrentmonitor, 4"
          "$mainMod CTRL, 5, focusworkspaceoncurrentmonitor, 5"
          "$mainMod CTRL, 6, focusworkspaceoncurrentmonitor, 6"
          "$mainMod CTRL, 7, focusworkspaceoncurrentmonitor, 7"
          "$mainMod CTRL, 8, focusworkspaceoncurrentmonitor, 8"
          "$mainMod CTRL, 9, focusworkspaceoncurrentmonitor, 9"
          "$mainMod CTRL, 0, focusworkspaceoncurrentmonitor, 10"
